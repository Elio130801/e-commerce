...
export default function AdminLoginPage() {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        try {
            // Llamamos a tu controlador AuthController
            ...
            if (response.ok) {
                ...
                // 🔑 ¡AQUÍ ESTÁ LA MAGIA! Guardamos el token en el almacenamiento del navegador
                localStorage.setItem("admin_token", data.access_token);
        
                alert("¡Bienvenido al Panel de Control! 👑");
                router.push("/admin/orders"); // Lo mandamos al panel de ventas
            } else {
